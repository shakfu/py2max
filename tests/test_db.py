...
class TestMaxRefDB:
    ...
    def test_insert_complex_object(self):
        ...
        test_data = {
            ...
            "outlets": [{"id": "0", "type": "signal", "digest": "Output"}],
            "objargs": [
                {
                    "name": "frequency",
                    "optional": "0",
                    "type": "float",
                    "digest": "Initial frequency",
                }
            ],
            "methods": {
                "bang": {
                ...
                "int": {
                    ...
                    "args": [{"name": "value", "type": "int", "optional": "0"}],
                },
            },
            "attributes": {
                "frequency": {
            ...
            "examples": [{"name": "basic", "caption": "Basic usage"}],
            "seealso": ["related_obj1", "related_obj2"],
            "misc": {"Output": {"signal": "Filtered signal"}},
            "palette": {"category": "MSP Filters", "palette_index": "5"},
            "parameter": {"enable": "1"},
        }
    ...
    def test_search_objects(self):
        ...
        test_objects = [
            ...
            },
            {
                "name": "dsp_effect",
                "digest": "DSP effect",
                "description": "Applies audio effect",
                "metadata": {},
                "inlets": [],
                "outlets": [],
                "objargs": [],
