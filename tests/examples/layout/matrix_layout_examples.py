...
def create_parallel_voices_matrix():
    ...
    env1 = p.add_textbox('adsr~ 10 100 0.7 500', comment="Voice 1 Env", comment_pos="above")
    gain1 = p.add_textbox('*~', comment="Voice 1 VCA", comment_pos="above")
    filter1 = p.add_textbox('lores~ 1000', comment="Voice 1 Filter", comment_pos="above")
    ...
    env2 = p.add_textbox('adsr~ 5 50 0.5 300', comment="Voice 2 Env", comment_pos="above")
    gain2 = p.add_textbox('*~', comment="Voice 2 VCA", comment_pos="above")
    filter2 = p.add_textbox('lores~ 1500', comment="Voice 2 Filter", comment_pos="above")
    ...
    env3 = p.add_textbox('adsr~ 20 200 0.9 800', comment="Voice 3 Env", comment_pos="above")
    ...
    print(f"Matrix size: {chain_info['matrix_size'][0]} rows × {chain_info['matrix_size'][1]} columns")
...
def create_effects_chain_matrix():
    ...
    input_sel = p.add_textbox('selector~ 3', comment="Input Selector", comment_pos="above")
