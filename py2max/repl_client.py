...
class ReplClient:
    ...
    async def connect(self):
        ...
        try:
            ...
            print(f"  py2max serve <patch.maxpat>")
            print()
            raise
    ...
    async def run_repl(self):
        ...
        # Build namespace with remote execution
        namespace = {
            "__name__": "__main__",
            "__doc__": None,
    ...
    async def _ptpython_repl(self):
        ...
        """
        # Create a remote execution namespace
        namespace = {
            "_client": self,
            "_execute": self.execute,
        }

        # Custom evaluator that executes remotely
        ...
        evaluator = RemoteEvaluator(self)
