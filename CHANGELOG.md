...
### Fixed: js2max -- a review pass over the `v8` bridge

A read-through of the feature above, which found seven defects. Tests went from 126 to 182; `make js2max-check` covers all of it, and there is now a CI job that runs it.
...
### Changed: js2max -- what a box knows, and what it is called
