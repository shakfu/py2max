...
**Location**: <span class="title-ref">tests/test_core\*.py</span>, <span class="title-ref">tests/test_basic.py</span>
...
**Location**: <span class="title-ref">tests/test_layout\*.py</span>
...
**Location**: <span class="title-ref">tests/test_maxref.py</span>
...
**Location**: <span class="title-ref">tests/test_connection_validation.py</span>
...
**Location**: <span class="title-ref">tests/test_abstract_coverage.py</span>
...
**Location**: <span class="title-ref">tests/test\_\*.py</span> (individual object types)
